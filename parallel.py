...
start_time = perf_counter() # запускаем таймер
...
end_time = perf_counter() # стопим таймер

print(f'Выполнение с использованием 10 потоков заняло{end_time- start_time: 0.2f} секунд.')
...
print(f'выполнение без использования 10ти потоков заняло {end_time2- start_time2: 0.2f} секунд.')
